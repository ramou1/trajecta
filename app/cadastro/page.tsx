...
function CadastroContent() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (cadastrar(nome || 'Usuário', email || 'usuario@email.com', telefone || '', senha || 'senha')) {
      router.replace('/consulta');
    } else {
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl p-8 space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  style={{ '--tw-ring-color': CORES_TRAJECTA.azulMedio } as React.CSSProperties}
          ...
          <div className="text-center pt-4 border-t border-gray-200">
            <p className="text-sm text-gray-600">
              Já tem uma conta?{' '}
              <Link href="/login" className="font-semibold hover:opacity-80 transition-colors" style={{ color: CORES_TRAJECTA.azulMedio }}>
                Fazer login
              </Link>
            </p>
          </div>
